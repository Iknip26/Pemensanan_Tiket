...
class fillform : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            val adapterJenisTiket = ArrayAdapter(this@fillform, R.layout.simple_spinner_item, jenis_tiket);
            ...
            buttonConfirm.setOnClickListener {
                if(asalText.text.toString() != "" && tujuanText.text.toString() != "" && desc1.text != "DD / MM / YY" && desc2.text!="HH : MM"){
                    val intentConfirm = Intent(this@fillform, konfirmasi::class.java)
                    ...
                    Toast.makeText(this@fillform, "KOLOM TIDAK BOLEH KOSONG !", Toast.LENGTH_SHORT).show()
                }
            }
